...
optim = c(NA, 2, 32, 247.5, 16.875, # i_PKDX i_lipidkX i_lipid i_Itga5Itgb1Fn1nMb i_Sacm1lX
          .6, 0.00053*1.2,  #  Input_Lipid  Input_PKD1x
          ...
          0.001/1.6, 0.0009*1.3,0.009,0.01, # Activation_PKDx Inactivation_PRDKX Activation_LipidKx Inactivation_LipidKX 
          ...
          0.18, # VesicleBudding
          0.0005*1.5, 0.0022/61, # CostMAPKA CostMAPKB
